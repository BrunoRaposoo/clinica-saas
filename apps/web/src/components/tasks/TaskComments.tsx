    ...
    <div className="bg-pink-50 rounded-lg p-3 sm:p-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-pink-600 text-white text-sm rounded hover:bg-pink-700"
                  >
                    Salvar
                  </button>
                  <button
      ...
      <div className="flex flex-col gap-2">
        <input
          ...
          className="w-full px-3 py-2 text-sm border rounded focus:outline-none focus:ring-2 focus:ring-pink-500"
        ...
        <button
          ...
          className="w-full px-4 py-2 bg-pink-600 text-white text-sm rounded hover:bg-pink-700 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
        >
          Enviar
        </button>
      </div>
